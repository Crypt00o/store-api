...
beforeAll(async()=>{
    createdUser= await usermodel.create({email:"crypto404@crypto.com",
    password:"nopassword",
    first_name:"0x",
    last_name:"Crypt00o"})
    ...
    it("[+] Testing Functionality Of Create ",async()=>{
        ...
        const orderToCreate={ order_status:"not Delieverd ",
        user_id:createdUser.user_id as string}
    ...
    it ("[+] Testing Functionality Of Update ",async()=>{
       const orderToUpdate :Order ={order_status:"Delivered ",order_id:createdOrder0.order_id ,user_id:createdUser.user_id as string}
    ...
    it("[+] Testing Functionality Of insertOrderedProduct",async()=>{
     const orderedProductToInsert:OrderedProduct={quantity:3,product_id:createdProduct.product_id as string,order_id:createdOrder0.order_id as string}
